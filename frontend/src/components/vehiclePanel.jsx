...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div onClick={()=>{props.setConfirmPanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
          ...
          <h2 className='text-xl font-semibold'>$19.20</h2>
        </div>
        <div onClick={()=>{props.setConfirmPanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
          ...
          <h2 className='text-xl font-semibold'>$7.20</h2>
        </div>
        <div onClick={()=>{props.setConfirmPanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
          ...
          <h2 className='text-xl font-semibold'>$14.20</h2>
        </div>
    </div>
  )
}
