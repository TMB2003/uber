    ...
    <div className="p-7 h-screen flex flex-col justify-between bg-gray-100">
      <div>
        ...
        <form onSubmit={submitHandler} className="bg-white p-8 rounded-lg shadow-lg mt-8">
          ...
          <label className="block text-xl font-semibold mb-2 text-gray-700">What's our Captain's Name?</label>
          ...
          <label className="block text-xl font-semibold mb-2 text-gray-700">What's our Captain's Email?</label>
          <input
            type="email"
            required
          ...
          <p className="text-center mt-4 text-gray-600">
            Already have an account? <Link to="/captain-login" className="text-indigo-600">Login as Captain</Link>
          </p>
        </form>
      </div>
      <div>
